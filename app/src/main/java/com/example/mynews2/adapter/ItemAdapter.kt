...
import com.example.mynews2.activity.MainActivity
import com.example.mynews2.model.DataModel

class ItemAdapter(private val context: Context, private val dataList: List<DataModel>, private val listener: MainActivity) : RecyclerView.Adapter<ItemAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.apply {
            ...
            /*
            glide is used to load image in an optimized way
             */
            Glide.with(context)
    ...
    interface OnRecyclerViewItemClickListener{
        fun onItemClicked(position: Int ,url_adapter: String , title_adapter : String , desc_adapter: String  , time_adapter: String)
    }
